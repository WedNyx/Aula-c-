...
assert.match(badge,/aria-haspopup="dialog"/);
assert.match(badge,/CURRENT_RELEASE\.highlights/);
assert.match(badge,/Principais novidades/);
...
console.log('Controles da chamada/turno e resumo de versão: contratos aprovados.');
