...
const skins = ['prisma-orbital','orbita','guardiao','aurora','lua-nova','mare','constelacao','lunar','eclipse'];
...
console.log('9 aparências do Nyx possuem estrutura e superfície próprias.');
