...
export const pageBgFor = (theme) => theme === "light" ? LIGHT_BG : theme === "spartan" ? SPARTAN_BG : (typeof theme === "string" && theme.startsWith("#")) ? customBg(theme) : PAGE_BG;
