...
import { musicEmbed } from "../lib/musicSearch.js";
...
export function ClassMusicPlayer({ settings, compact=false, onSuggest }) {
  ...
  useEffect(()=>{
    setError("");
    if(!embed)audioRef.current?.load();
  },[track?.url,embed?.src]);
