...
export const TEACHER_TOUR_STEPS = [
  ...
  { tab:"music", sel:'[data-tour-prof="music"]', emoji:"🎵", title:"Música da turma", text:"Libere ou bloqueie música por turma, pesquise faixas no YouTube ou Spotify e escolha onde o player oficial aparecerá. Só o professor adiciona ou aprova o que entra na playlist." },
