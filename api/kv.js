...
const SET_PROTECTED_PREFIXES = ['teachercode:', 'nyxlocks:', 'exam:config', 'codesend:', 'accessmode:', 'support:', 'boss:', 'kick:', 'scorefix:', 'teachermeta:', 'classroom_reset_flag', 'nudge:']
const DELETE_PROTECTED_PREFIXES = ['student:', 'teachercode:', 'nyxlocks:', 'exam:config', 'accessmode:', 'support:', 'boss:', 'kick:', 'teachermeta:', 'classroom_reset_flag']
